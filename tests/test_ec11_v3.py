# test_ec11_v3.py -- Rotary encoder (EC11 / PEC12R) test for XIAO RP2040
# ===================================================================
# Diagnostic version with wiring check and continuous raw state display.
# Run this FIRST to verify your encoder wiring is correct.
#
# Wiring:
...
print("=" * 50)
print("EC11 ENCODER TEST v3 — Diagnostic")
print("=" * 50)
print()
